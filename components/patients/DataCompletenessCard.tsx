      ...
      <div className="glass-card p-5 border border-blue-500/20 shadow-xl space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 pt-1">
          {report.categories.map(cat => {
            ...
            return (
              <div key={cat.name} className="p-2.5 rounded-xl bg-slate-900/60 border border-blue-500/10 space-y-1.5">
                <div className="flex justify-between items-center text-[11px]">
                  <span className="text-gray-400 font-medium truncate">{cat.name}</span>
