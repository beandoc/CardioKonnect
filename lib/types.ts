...
export const BUILT_IN_FIELDS: RegistryField[] = [
  { id: '1',  srNo: 1,  fieldName: 'visitDate',    displayLabel: 'Visit Date',             dataType: 'Date',       mandatory: true,  pii: false, active: true, category: 'Visit' },
  { id: '2',  srNo: 2,  fieldName: 'visitType',    displayLabel: 'Visit Type',             dataType: 'Dropdown',   mandatory: true,  pii: false, active: true, category: 'Visit' },
  { id: '3',  srNo: 3,  fieldName: 'nyha',         displayLabel: 'NYHA Class',             dataType: 'Dropdown',   mandatory: false, pii: false, active: true, category: 'Clinical' },
  { id: '4',  srNo: 4,  fieldName: 'lvef',         displayLabel: 'LVEF (%)',               dataType: 'Number',     mandatory: false, pii: false, active: true, category: 'Echo' },
  { id: '5',  srNo: 5,  fieldName: 'ntProBNP',     displayLabel: 'NT-proBNP (pg/mL)',      dataType: 'Number',     mandatory: false, pii: false, active: true, category: 'Labs' },
  { id: '6',  srNo: 6,  fieldName: 'hsTnT',        displayLabel: 'hs-TnT (pg/mL)',         dataType: 'Number',     mandatory: false, pii: false, active: true, category: 'Biomarkers' },
  { id: '7',  srNo: 7,  fieldName: 'hsCrp',        displayLabel: 'hs-CRP (mg/L)',          dataType: 'Number',     mandatory: false, pii: false, active: true, category: 'Biomarkers' },
  { id: '8',  srNo: 8,  fieldName: 'il6',          displayLabel: 'IL-6 (pg/mL)',           dataType: 'Number',     mandatory: false, pii: false, active: true, category: 'Biomarkers' },
  { id: '9',  srNo: 9,  fieldName: 'gls',          displayLabel: 'GLS (%)',                dataType: 'Number',     mandatory: false, pii: false, active: true, category: 'Echo' },
  { id: '10', srNo: 10, fieldName: 'pulseWaveVelocity', displayLabel: 'Pulse Wave Velocity (m/s)', dataType: 'Number', mandatory: false, pii: false, active: true, category: 'Vascular' },
]
